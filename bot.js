...
client.user.setGame(`-bc | Virus`,"http://twitch.tv/Death Shop")
        ...
        if(!message.channel.guild) return;
            ...
            if(command == "bc") {
                if(!message.member.hasPermission("ADMINISTRATOR")) {
                    return message.channel.send("**للأسف لا تستطيع يا كلب لأنك مو من الادارة `ADMINISTRATOR`**");
                }
                    if(!args) {
                        return message.reply("**يا نوب , لازم تكتب جملة حتى يتم ارسال البرودكاست**");
                    }
            ...
            if(command == "bco") {
                if(!message.member.hasPermission("ADMINISTRATOR")) {
                    return message.channel.send("**يا نوب , لازم تكتب جملة حتى يتم ارسال البرودكاست `ADMINISTRATOR`**");
                }
                    if(!args) {
                        return message.reply("**يا نوب , لازم تكتب جملة حتى يتم ارسال البرودكاست**");
                    }
